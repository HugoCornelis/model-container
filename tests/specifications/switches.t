				...
				command_tests => [
						  {
						   ...
						   read => "0,golgi.ndf   ,15	||  ->Dependency file(/tmp/neurospaces/test/models/mappers/spikegenerator.ndf)
0,golgi.ndf   ,15	||  ->End(/tmp/neurospaces/test/models/mappers/spikegenerator.ndf)
0,golgi.ndf   ,17	||  ->Dependency file(/tmp/neurospaces/test/models/legacy/channels/golgi_inna.ndf)
0,golgi.ndf   ,17	||  ->End(/tmp/neurospaces/test/models/legacy/channels/golgi_inna.ndf)
0,golgi.ndf   ,19	||  ->Dependency file(/tmp/neurospaces/test/models/legacy/channels/golgi_kdr.ndf)
0,golgi.ndf   ,19	||  ->End(/tmp/neurospaces/test/models/legacy/channels/golgi_kdr.ndf)
0,golgi.ndf   ,21	||  ->Dependency file(/tmp/neurospaces/test/models/legacy/channels/golgi_ka.ndf)
0,golgi.ndf   ,21	||  ->End(/tmp/neurospaces/test/models/legacy/channels/golgi_ka.ndf)
0,golgi.ndf   ,23	||  ->Dependency file(/tmp/neurospaces/test/models/legacy/channels/golgi_cahva.ndf)
0,golgi.ndf   ,23	||  ->End(/tmp/neurospaces/test/models/legacy/channels/golgi_cahva.ndf)
0,golgi.ndf   ,25	||  ->Dependency file(/tmp/neurospaces/test/models/legacy/channels/golgi_h.ndf)
0,golgi.ndf   ,25	||  ->End(/tmp/neurospaces/test/models/legacy/channels/golgi_h.ndf)
0,golgi.ndf   ,27	||  ->Dependency file(/tmp/neurospaces/test/models/legacy/channels/golgi_kc.ndf)
0,golgi.ndf   ,27	||  ->End(/tmp/neurospaces/test/models/legacy/channels/golgi_kc.ndf)
0,golgi.ndf   ,29	||  ->Dependency file(/tmp/neurospaces/test/models/channels/golgi_nmda.ndf)
1,golgi_nmda.n,15	||    ->Dependency file(/tmp/neurospaces/test/models/mappers/spikereceiver.ndf)
1,golgi_nmda.n,15	||    ->End(/tmp/neurospaces/test/models/mappers/spikereceiver.ndf)
0,golgi.ndf   ,29	||  ->End(/tmp/neurospaces/test/models/channels/golgi_nmda.ndf)
0,golgi.ndf   ,31	||  ->Dependency file(/tmp/neurospaces/test/models/channels/golgi_ampa.ndf)
1,golgi_ampa.n,15	||    ->Dependency file(/tmp/neurospaces/test/models/mappers/spikereceiver.ndf)
1,golgi_ampa.n,15	||    ->End(/tmp/neurospaces/test/models/mappers/spikereceiver.ndf)
0,golgi.ndf   ,31	||  ->End(/tmp/neurospaces/test/models/channels/golgi_ampa.ndf)
0,golgi.ndf   ,33	||  ->Dependency file(/tmp/neurospaces/test/models/channels/golgi_gabaa.ndf)
1,golgi_gabaa.,15	||    ->Dependency file(/tmp/neurospaces/test/models/mappers/spikereceiver.ndf)
1,golgi_gabaa.,15	||    ->End(/tmp/neurospaces/test/models/mappers/spikereceiver.ndf)
0,golgi.ndf   ,33	||  ->End(/tmp/neurospaces/test/models/channels/golgi_gabaa.ndf)
0,golgi.ndf   ,35	||  ->Dependency file(/tmp/neurospaces/test/models/channels/golgi_gabab.ndf)
1,golgi_gabab.,15	||    ->Dependency file(/tmp/neurospaces/test/models/mappers/spikereceiver.ndf)
1,golgi_gabab.,15	||    ->End(/tmp/neurospaces/test/models/mappers/spikereceiver.ndf)
0,golgi.ndf   ,35	||  ->End(/tmp/neurospaces/test/models/channels/golgi_gabab.ndf)
0,golgi.ndf   ,37	||  ->Dependency file(/tmp/neurospaces/test/models/pools/golgi_ca.ndf)
0,golgi.ndf   ,37	||  ->End(/tmp/neurospaces/test/models/pools/golgi_ca.ndf)
./neurospacesparse: No errors for /tmp/neurospaces/test/models/legacy/cells/golgi.ndf.
",
						   timeout => 3,
						   write => undef,
						  },
				...
				command_tests => [
						  {
						   ...
						   read => "1,mossyfibersm,90	||    Import Algorithm(Grid3D -> MossyGrid)
...
./neurospacesparse: No errors for /tmp/neurospaces/test/models/legacy/networks/networksmall.ndf.
",
						   timeout => 3,
						   write => undef,
						  },
				...
				command_tests => [
						  {
						   ...
						   read => "1,golgi_nmda.n,17	||    Activating golgi_nmda.ndf's dependencies(dependency list not yet)
1,golgi_nmda.n,23	||    Activating golgi_nmda.ndf's private models(private models list not yet)
1,golgi_nmda.n,23	||    Activating golgi_nmda.ndf's private models(private models list not yet)
1,golgi_ampa.n,15	||    /tmp/neurospaces/test/models/mappers/spikereceiver.ndf is cached(public model list not yet)
...
1,golgi_ampa.n,23	||    Activating golgi_ampa.ndf's private models(private models list not yet)
1,golgi_gabaa.,15	||    /tmp/neurospaces/test/models/mappers/spikereceiver.ndf is cached(public model list not yet)
...
1,golgi_gabaa.,23	||    Activating golgi_gabaa.ndf's private models(private models list not yet)
1,golgi_gabab.,15	||    /tmp/neurospaces/test/models/mappers/spikereceiver.ndf is cached(public model list not yet)
				...
				command_tests => [
						  {
						   ...
						   read => "1,spikegenerat,20	||    Add Public Model(T_sym_attachment,SpikeGen)
...
./neurospacesparse: No errors for /tmp/neurospaces/test/models/legacy/cells/granule.ndf.
",
						   timeout => 3,
						   write => undef,
						  },
