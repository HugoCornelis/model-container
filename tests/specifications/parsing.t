...
my $test
    = {
       command_definitions => [
				...
				command_tests => [
						  {
						   description => "Is neurospaces startup successful (channels/gaba.xml) ?",
						   read => [ '-re', './neurospacesparse: No errors for .+?/channels/gaba.xml.', ],
						   timeout => 5,
						  },
						 ],
				description => "syntax of channels/gaba.xml",
			       },
			       {
				arguments => [
					      '-v',
				...
				arguments => [
					      ...
					      '-p',
					      '-R',
					      'library/pulsegen/pulsegen1.ndf',
					     ],
				command => './neurospacesparse',
				command_tests => [
						  {
						   description => "Is neurospaces startup successful (pulsegen/pulsegen1.ndf) ?",
