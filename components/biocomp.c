...
(struct symtab_BioComponent *pbio, struct PidinStack *ppist, char *pcName, int iPosition)
{
    //- set default result: none
	...
	ppistResult = IOListResolveInput(&pbioPrototype->ioh.iol, ppist, pcName, iPosition);
