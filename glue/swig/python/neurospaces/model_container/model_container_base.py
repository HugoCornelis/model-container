...
class symtab_InputOutput(_object):
    ...
    __swig_setmethods__["iFlags"] = _model_container_base.symtab_InputOutput_iFlags_set
    __swig_getmethods__["iFlags"] = _model_container_base.symtab_InputOutput_iFlags_get
    if _newclass:iFlags = _swig_property(_model_container_base.symtab_InputOutput_iFlags_get, _model_container_base.symtab_InputOutput_iFlags_set)
    def __init__(self, *args): 
