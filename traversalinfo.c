...
/* 
 * \fun int TraversalInfoCollectorPostProcessor(struct TreespaceTraversal *ptstr, void *pvUserdata)
 * \param ptstr A pointer to the current Treespace traversal
 * \param pvUserdata Pointer to the user data
 * 
 * \return SymbolProcessor return value.
 * 
 * \details 
 * 
 *	Collect information about traversed symbols, see
